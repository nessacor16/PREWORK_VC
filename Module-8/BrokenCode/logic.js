...
$("#factButton").on("click", function() {
	// We generate a randeom number between 0 and 4 (the number of facts in the booFactsArray)
...
var booFactArray = ["Boo is a pomeranian", "Boo's best friend is another pomeranian named Buddy", "Boo the Pomeranian was born on March 16", "boo is a Pisces", "Boo's favorite food is grass", "Boo has released two books" ]
